...
class MedicalGraph:
    def __init__(self):
        ...
        self.data_path = os.path.join(cur_dir, 'data/medical2.json.bak')
    ...
    def create_diseases_nodes(self, disease_infos):
        ...
        for disease_dict in disease_infos:
            ...
            self.g.create(node)
            count += 1
            print("create_diseases_nodes", count)
        return
    ...
    def create_graphnodes(self):
        ...
        print("The len of Drugs", len(Drugs))
        self.create_node('Drug', Drugs)
        print("The len of Foods", len(Foods))
        self.create_node('Food', Foods)
        print("The len of Checks", len(Checks))
        self.create_node('Check', Checks)
        print("The len of Departments", len(Departments))
        self.create_node('Department', Departments)
        print("The len of Producers", len(Producers))
